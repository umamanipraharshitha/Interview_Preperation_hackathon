...
SPREADSHEET_ID = "1dVuJGfKpwzl-78dEZjwsPt4SRPMgPYlxzCV2C4Xh72A"
SHEET_NAME = "Sheet1"
...
def process_resumes_from_drive():
    ...
    FOLDER_ID = "1XfXL0RFvCDYwJ2LdqRBaHAaLVEYowMYk"
    ...
    for f in files:
        ...
        send_email("mpraharshitha2006@gmail.com", subject=f"AI Resume Summary - {file_name}", body=email_body)
